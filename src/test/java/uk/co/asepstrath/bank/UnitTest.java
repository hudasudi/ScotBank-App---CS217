...
public class UnitTest {
	...
	// THIS TEST WON'T WORK WITH DB BECAUSE WE'RE NOT READING FROM JSON ANYMORE
//	@Test
//	public void AccountApiManipulatorTest(){
//		Logger log = mock(Logger.class);
//
//		AccountAPIManipulator testManipulator = new AccountAPIManipulator(log, null);
//
//		assertNotNull(testManipulator);
//
//		ArrayList<Account> testList = testManipulator.jsonToAccounts();
//
//		assertEquals("Miss Lavina Waelchi",testList.get(0).getName());
//		Map<String, Object> map = testManipulator.createHandleBarsJSONMap();
//		assertEquals("[[{round=No, name=Miss Lavina Waelchi, bal=544.91, uuid=c9dfe369-c5f8-44fd-b9e2-f4fc5ac56ac2}]]",map.get("account_chunks").toString());
//	}
